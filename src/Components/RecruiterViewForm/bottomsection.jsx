...
function BottomSection({ cData, isOutsideIndia }) {
  ...
  const headerOutsideIndia = [
    ...
    [
      cbData.adharCard,
      cbData.panCard,
      cbData.employeesName,
      cbData.dateOfBirthAs,
      cbData.gender,
      cbData.maritalStatus,
      cbData.fatherName,
      cbData.bankName,
      cbData.branch,
      cbData.accountNumber,
      cbData.ifsc
    ]
  ];
  ...
  return (
    <div className=" margin-mobile" style={{ width: "100%" }}>
      {!isOutsideIndia && familyMembers?.length > 0 && (
        <Container
          style={{
            background: "white",
            ...
            <Form className="forms">
              ...
              <Row>
                {contact?.emergencyContactNumber && (
                  <Col xs={12} md={4}>
                    <Form.Group
                      controlId="EmergencyPhoneNumber"
                      className="mt-3"
                    >
        ...
        <>
          ...
          >
            <div className="FamilyDet">
              ...
              <div className="buttons">
                <CSVLink
                  data={headerOutsideIndia}
                  filename={"Bank Account_details.csv"}
                  className="buttonss"
                >
                  <Button
                    style={{ backgroundColor: "#7F56D9", border: "none" }}
                  ...
                  <Row>
                    ...
                    <Col xs={12} md={4}>
                      <Form.Group
                        ...
                        controlId="formGroupEmail"
                      >
                        <Form.Label className="labelss">Bank Branch Name</Form.Label>
                        <Form.Control
                          className="input-field"
                          type="text"
                          value={cbData.branch}
